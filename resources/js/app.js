...
Vue.component('church-component', require('./components/ChurchComponent.vue').default);
Vue.component('ministry-component', require('./components/MinistryComponent.vue').default);
